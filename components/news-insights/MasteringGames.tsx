        ...
        <div className="xl:mt-[190px] lg:mt-[108px] md:mt-[60px] mt-[48px] relative z-20 before:content-[''] before:absolute before:w-[457px] before:h-[457px] before:-top-24 before:-left-40 before:bg-shadow_blue before:blur-[111px] before:opacity-25 before:-z-10 before:rounded-full">
          ...
          <div className="lg:mt-14 md:mt-7 mt-5 relative z-20 before:content-[''] before:absolute before:w-[448px] before:h-[448px] before:-top-20 before:-end-60 before:bg-shadow_blue before:blur-[111px] before:opacity-25 before:-z-10 before:rounded-full">
            <h3
              ...
              data-aos-delay="200"
              data-aos-offset="200"
              className="font-HelveticaNeueMedium text-[#FDFEFF]  font-medium text-[22px] sm:text-lg leading-8 md:leading-[39px]"
            >
            ...
            <p
              ...
              data-aos-delay="200"
              data-aos-offset="200"
              className="font-Segoe text-[#B1B5B8] mt-2 font-normal text-base"
            >
            ...
            <p
              ...
              data-aos-delay="200"
              data-aos-offset="200"
              className="font-Segoe font-normal text-md lg:mt-4 mt-2 leading-7 text-[#B1B5B8]"
            >
              ...
              understands the intricacies of the game and utilizes strategies to
              maximize their team's strengths while exploiting the weaknesses of
              their opponents.
            </p>
          </div>
          <div className="mt-6">
            <h3
              ...
              data-aos-delay="200"
              data-aos-offset="200"
              className="font-HelveticaNeueMedium text-[#FDFEFF] font-medium text-[22px] sm:text-basemd leading-8 md:leading-[39px] m-0"
            >
            ...
            <p
              ...
              data-aos-delay="200"
              data-aos-offset="200"
              className="font-Segoe font-normal text-md leading-7 text-[#B1B5B8] mt-2 lg:scroll-pt-0.5 lg:max-w-[1140px]"
            >
              Are you ready to unlock your full potential and leave your mark on
              the football field? Join us on a journey of inspiration and
              transformation as we embark on a relentless pursuit of greatness.
              Our dedicated coach is here to guide, motivate, and push you
              beyond your limits, instilling in you the unwavering belief that
              anything is possible. Through intense training, tactical mastery,
              and unwavering discipline, we will shape you into a formidable
              force on the pitch.
            </p>
          </div>
          <div
            ...
            className="mt-6"
          >
            <h3 className="font-HelveticaNeueMedium text-[#FDFEFF] font-medium text-[22px] sm:text-basemd leading-8 md:leading-[39px] m-0">
            ...
            <p
              ...
              data-aos-delay="200"
              data-aos-offset="200"
              className="font-Segoe font-normal text-md leading-7 text-[#B1B5B8] mt-2 lg:pt-0.5 lg:max-w-[1024px]"
            >
