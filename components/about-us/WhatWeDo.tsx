        ...
        <div className="container md:max-w-full xl:max-w-[1140px] 2xl:max-w-[1320px] mx-auto px-3 relative z-10">
          <div className="flex flex-col lg:flex-row justify-between">
            <div className="lg:w-1/2">
              <div className="flex flex-col justify-center h-full lg:pe-6 xl:p-0 text-center lg:text-start lg:mt-20">
                <h2 className="font-HelveticaNeueMedium font-medium md:text-5xl text-4xl leading-[60px] text-[#FDFEFF] md:mb-4">
                ...
                <p className="font-Segoe font-normal text-md md:max-w-[530px] text-[#FDFEFF] mx-auto lg:ms-0 opacity-80 leading-7 md:pt-4 pt-2">
            ...
            <div className="lg:w-5/12 w-9/12 mx-auto lg:me-0 mt-8 lg:mt-6">
