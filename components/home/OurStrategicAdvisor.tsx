      ...
      <div className="bg-strategic-advisor bg-no-repeat bg-cover">
        <div className="container">
          <div
            ...
            data-aos-delay="200"
            data-aos-offset="200" className="flex items-center justify-center lg:gap-8 xl:gap-[114px] flex-col-reverse lg:flex-row pt-14 pb-14 xl:pt-[95px] xlpb-[150px]">
            <Image
            ...
            data-aos-easing="linear"
            data-aos-delay="200"
            data-aos-offset="200" className="lg:max-w-[555px]">
              <h3
                className="text-primary font-HelveticaNeueMedium text-[26px] sm:text-[36px] xl:text-5xl lg:text-[43px] md:text-[40px] font-medium lg:!leading-[60px] sm:leading-[45px] md:leading-[58px] leading-[36px] text-center lg:text-start"
              ...
              <p
                className="text-primary text-base md:text-md font-Segoe font-normal opacity-80 mt-4 text-center lg:text-start"
