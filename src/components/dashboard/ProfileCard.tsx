...
<div className="w-[400px] lg:mx-auto h-[500px] bg-cyan-950 rounded-10 p-4 mb-4">
    <h2 className='text-primary text-[24px] mb-2'>Profile</h2>
  ...
  <tbody className="font-extralight text-base">
      ...
      <tr  className='border-b border-offwhite py-4'>
  ...
  <h3 className='text-primary text-md pt-4 py-1.5'>Bio</h3>
  <p className='text-primary font-extralight text-sm'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<br/>
