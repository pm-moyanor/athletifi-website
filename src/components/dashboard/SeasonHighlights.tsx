    ...
    >
      <div className="">
        ...
        <p className="text-[16px] text-primary font-extralight max-w-[560px] md:max-w-[440px] pr-2">
          ...
          numquam commodi hic labore. <span className=" block h-2" /> Lorem
          ...
          veniam? <span className=" block h-2" />
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Esse
          recusandae, commodi eveniet ipsa Nesciunt similique ducimus et?{' '}
          <span className=" block h-2" /> Lorem ipsum dolor sit amet consectetur
