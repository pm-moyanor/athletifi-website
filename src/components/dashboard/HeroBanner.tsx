  ...
  return (
    <>
      <section className='flex flex-col justify-center items-stretch lg:flex-row h-full gap-5'>
        <div className='lg:w-3/4 xl:w-1/2 2xl:w-1/2 min-h-full'>
        ...
        <div className='lg:w-full xl:w-1/2 2xl:w-1/2 min-h-full h-full flex justify-center items-center lg:my-5 xl:my-0'>
          <Image
            className=''
            src={cardImage}
            alt='Player card'
